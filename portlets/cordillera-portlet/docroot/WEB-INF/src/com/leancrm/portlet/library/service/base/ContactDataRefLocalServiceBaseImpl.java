...
import com.leancrm.portlet.library.service.ContactDataRefLocalService;
...
/**
 * Provides the base implementation for the contact data ref local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.ContactDataRefLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContactDataRefLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContactDataRefLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.ContactDataRefLocalServiceUtil} to access the contact data ref local service.
	 */
	...
	@Override
	public ContactDataRef addContactDataRef(ContactDataRef contactDataRef)
		throws SystemException {
		contactDataRef.setNew(true);

		return contactDataRefPersistence.update(contactDataRef);
	}
	 ...
	 */
	@Override
	public ContactDataRef createContactDataRef(long contactDataId) {
		return contactDataRefPersistence.create(contactDataId);
	}
	...
	@Override
	public ContactDataRef deleteContactDataRef(long contactDataId)
		throws PortalException, SystemException {
		return contactDataRefPersistence.remove(contactDataId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ContactDataRef deleteContactDataRef(ContactDataRef contactDataRef)
		throws SystemException {
		return contactDataRefPersistence.remove(contactDataRef);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContactDataRef.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactDataRefPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactDataRefPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ContactDataRef fetchContactDataRef(long contactDataId)
		throws SystemException {
		return contactDataRefPersistence.fetchByPrimaryKey(contactDataId);
	}
	 ...
	 */
	@Override
	public ContactDataRef getContactDataRef(long contactDataId)
		throws PortalException, SystemException {
		return contactDataRefPersistence.findByPrimaryKey(contactDataId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactDataRefPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ContactDataRef> getContactDataRefs(int start, int end)
		throws SystemException {
		return contactDataRefPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getContactDataRefsCount() throws SystemException {
		return contactDataRefPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ContactDataRef updateContactDataRef(ContactDataRef contactDataRef)
		throws SystemException {
		return contactDataRefPersistence.update(contactDataRef);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.ContactDataRef",
			contactDataRefLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactDataRefPersistence.getDataSource();
	...
	private ContactDataRefLocalServiceClpInvoker _clpInvoker = new ContactDataRefLocalServiceClpInvoker();
}