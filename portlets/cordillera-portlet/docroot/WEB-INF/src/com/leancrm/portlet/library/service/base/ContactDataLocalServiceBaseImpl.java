...
import com.leancrm.portlet.library.service.ContactDataLocalService;
...
/**
 * Provides the base implementation for the contact data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.ContactDataLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContactDataLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContactDataLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.ContactDataLocalServiceUtil} to access the contact data local service.
	 */
	...
	@Override
	public ContactData addContactData(ContactData contactData)
		throws SystemException {
		contactData.setNew(true);

		return contactDataPersistence.update(contactData);
	}
	 ...
	 */
	@Override
	public ContactData createContactData(long contactDataId) {
		return contactDataPersistence.create(contactDataId);
	}
	...
	@Override
	public ContactData deleteContactData(long contactDataId)
		throws PortalException, SystemException {
		return contactDataPersistence.remove(contactDataId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ContactData deleteContactData(ContactData contactData)
		throws SystemException {
		return contactDataPersistence.remove(contactData);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContactData.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return contactDataPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactDataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ContactData fetchContactData(long contactDataId)
		throws SystemException {
		return contactDataPersistence.fetchByPrimaryKey(contactDataId);
	}
	...
	public ContactData getContactData(long contactDataId)
		throws PortalException, SystemException {
		return contactDataPersistence.findByPrimaryKey(contactDataId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ContactData> getContactDatas(int start, int end)
		throws SystemException {
		return contactDataPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getContactDatasCount() throws SystemException {
		return contactDataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ContactData updateContactData(ContactData contactData)
		throws SystemException {
		return contactDataPersistence.update(contactData);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.ContactData",
			contactDataLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactDataPersistence.getDataSource();
	...
	private ContactDataLocalServiceClpInvoker _clpInvoker = new ContactDataLocalServiceClpInvoker();
}