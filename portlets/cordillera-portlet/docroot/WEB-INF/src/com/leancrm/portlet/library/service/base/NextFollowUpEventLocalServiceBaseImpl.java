...
import com.leancrm.portlet.library.service.NextFollowUpEventLocalService;
...
/**
 * Provides the base implementation for the next follow up event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.NextFollowUpEventLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class NextFollowUpEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NextFollowUpEventLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.NextFollowUpEventLocalServiceUtil} to access the next follow up event local service.
	 */
	...
	@Override
	public NextFollowUpEvent addNextFollowUpEvent(
		NextFollowUpEvent nextFollowUpEvent) throws SystemException {
	 ...
	 */
	@Override
	public NextFollowUpEvent createNextFollowUpEvent(long eventId) {
		return nextFollowUpEventPersistence.create(eventId);
	}
	...
	@Override
	public NextFollowUpEvent deleteNextFollowUpEvent(long eventId)
		throws PortalException, SystemException {
		return nextFollowUpEventPersistence.remove(eventId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NextFollowUpEvent deleteNextFollowUpEvent(
		NextFollowUpEvent nextFollowUpEvent) throws SystemException {
		return nextFollowUpEventPersistence.remove(nextFollowUpEvent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NextFollowUpEvent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return nextFollowUpEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return nextFollowUpEventPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NextFollowUpEvent fetchNextFollowUpEvent(long eventId)
		throws SystemException {
		return nextFollowUpEventPersistence.fetchByPrimaryKey(eventId);
	}
	 ...
	 */
	@Override
	public NextFollowUpEvent getNextFollowUpEvent(long eventId)
		throws PortalException, SystemException {
		return nextFollowUpEventPersistence.findByPrimaryKey(eventId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return nextFollowUpEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NextFollowUpEvent> getNextFollowUpEvents(int start, int end)
		throws SystemException {
		return nextFollowUpEventPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNextFollowUpEventsCount() throws SystemException {
		return nextFollowUpEventPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NextFollowUpEvent updateNextFollowUpEvent(
		NextFollowUpEvent nextFollowUpEvent) throws SystemException {
		return nextFollowUpEventPersistence.update(nextFollowUpEvent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.NextFollowUpEvent",
			nextFollowUpEventLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = nextFollowUpEventPersistence.getDataSource();
	...
	private NextFollowUpEventLocalServiceClpInvoker _clpInvoker = new NextFollowUpEventLocalServiceClpInvoker();
}