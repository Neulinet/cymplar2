...
import com.leancrm.portlet.library.service.AddressBookContactLocalService;
...
/**
 * Provides the base implementation for the address book contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.AddressBookContactLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AddressBookContactLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AddressBookContactLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.AddressBookContactLocalServiceUtil} to access the address book contact local service.
	 */
	...
	public AddressBookContact addAddressBookContact(
		...
		return addressBookContactPersistence.update(addressBookContact);
	}
	 ...
	 */
	@Override
	public AddressBookContact createAddressBookContact(
		AddressBookContactPK addressBookContactPK) {
		return addressBookContactPersistence.create(addressBookContactPK);
	}
	...
	@Override
	public AddressBookContact deleteAddressBookContact(
		AddressBookContactPK addressBookContactPK)
		throws PortalException, SystemException {
		return addressBookContactPersistence.remove(addressBookContactPK);
	}
	...
	public AddressBookContact deleteAddressBookContact(
		AddressBookContact addressBookContact) throws SystemException {
		return addressBookContactPersistence.remove(addressBookContact);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AddressBookContact.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return addressBookContactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressBookContactPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AddressBookContact fetchAddressBookContact(
		AddressBookContactPK addressBookContactPK) throws SystemException {
		return addressBookContactPersistence.fetchByPrimaryKey(addressBookContactPK);
	}
	...
	public AddressBookContact getAddressBookContact(
		AddressBookContactPK addressBookContactPK)
		throws PortalException, SystemException {
		return addressBookContactPersistence.findByPrimaryKey(addressBookContactPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return addressBookContactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddressBookContact> getAddressBookContacts(int start, int end)
		throws SystemException {
		return addressBookContactPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAddressBookContactsCount() throws SystemException {
		return addressBookContactPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddressBookContact updateAddressBookContact(
		AddressBookContact addressBookContact) throws SystemException {
		return addressBookContactPersistence.update(addressBookContact);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.AddressBookContact",
			addressBookContactLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = addressBookContactPersistence.getDataSource();
	...
	private AddressBookContactLocalServiceClpInvoker _clpInvoker = new AddressBookContactLocalServiceClpInvoker();
}