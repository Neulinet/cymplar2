...
import com.leancrm.portlet.library.service.ContactDataMethodLocalService;
...
/**
 * Provides the base implementation for the contact data method local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.ContactDataMethodLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ContactDataMethodLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContactDataMethodLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.ContactDataMethodLocalServiceUtil} to access the contact data method local service.
	 */
	...
	@Override
	public ContactDataMethod addContactDataMethod(
		ContactDataMethod contactDataMethod) throws SystemException {
		contactDataMethod.setNew(true);

		return contactDataMethodPersistence.update(contactDataMethod);
	}
	 ...
	 */
	@Override
	public ContactDataMethod createContactDataMethod(long contactDataMethodId) {
		return contactDataMethodPersistence.create(contactDataMethodId);
	}
	...
	@Override
	public ContactDataMethod deleteContactDataMethod(long contactDataMethodId)
		throws PortalException, SystemException {
		return contactDataMethodPersistence.remove(contactDataMethodId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ContactDataMethod deleteContactDataMethod(
		ContactDataMethod contactDataMethod) throws SystemException {
		return contactDataMethodPersistence.remove(contactDataMethod);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContactDataMethod.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return contactDataMethodPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactDataMethodPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ContactDataMethod fetchContactDataMethod(long contactDataMethodId)
		throws SystemException {
		return contactDataMethodPersistence.fetchByPrimaryKey(contactDataMethodId);
	}
	 ...
	 */
	@Override
	public ContactDataMethod getContactDataMethod(long contactDataMethodId)
		throws PortalException, SystemException {
		return contactDataMethodPersistence.findByPrimaryKey(contactDataMethodId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactDataMethodPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ContactDataMethod> getContactDataMethods(int start, int end)
		throws SystemException {
		return contactDataMethodPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getContactDataMethodsCount() throws SystemException {
		return contactDataMethodPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ContactDataMethod updateContactDataMethod(
		ContactDataMethod contactDataMethod) throws SystemException {
		return contactDataMethodPersistence.update(contactDataMethod);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.ContactDataMethod",
			contactDataMethodLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactDataMethodPersistence.getDataSource();
	...
	private ContactDataMethodLocalServiceClpInvoker _clpInvoker = new ContactDataMethodLocalServiceClpInvoker();
}