...
import com.leancrm.portlet.library.service.AddressBookUserLocalService;
...
/**
 * Provides the base implementation for the address book user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.leancrm.portlet.library.service.impl.AddressBookUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AddressBookUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AddressBookUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.leancrm.portlet.library.service.AddressBookUserLocalServiceUtil} to access the address book user local service.
	 */
	...
	@Override
	public AddressBookUser addAddressBookUser(AddressBookUser addressBookUser)
		throws SystemException {
		addressBookUser.setNew(true);

		return addressBookUserPersistence.update(addressBookUser);
	}
	 ...
	 */
	@Override
	public AddressBookUser createAddressBookUser(long addressBookId) {
		return addressBookUserPersistence.create(addressBookId);
	}
	...
	@Override
	public AddressBookUser deleteAddressBookUser(long addressBookId)
		throws PortalException, SystemException {
		return addressBookUserPersistence.remove(addressBookId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AddressBookUser deleteAddressBookUser(
		AddressBookUser addressBookUser) throws SystemException {
		return addressBookUserPersistence.remove(addressBookUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AddressBookUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressBookUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressBookUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AddressBookUser fetchAddressBookUser(long addressBookId)
		throws SystemException {
		return addressBookUserPersistence.fetchByPrimaryKey(addressBookId);
	}
	 ...
	 */
	@Override
	public AddressBookUser getAddressBookUser(long addressBookId)
		throws PortalException, SystemException {
		return addressBookUserPersistence.findByPrimaryKey(addressBookId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return addressBookUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddressBookUser> getAddressBookUsers(int start, int end)
		throws SystemException {
		return addressBookUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAddressBookUsersCount() throws SystemException {
		return addressBookUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddressBookUser updateAddressBookUser(
		AddressBookUser addressBookUser) throws SystemException {
		return addressBookUserPersistence.update(addressBookUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.leancrm.portlet.library.model.AddressBookUser",
			addressBookUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = addressBookUserPersistence.getDataSource();
	...
	private AddressBookUserLocalServiceClpInvoker _clpInvoker = new AddressBookUserLocalServiceClpInvoker();
}