...
public class AddressBookLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return AddressBookLocalServiceUtil.addAddressBook((com.leancrm.portlet.library.model.AddressBook)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return AddressBookLocalServiceUtil.deleteAddressBook((com.leancrm.portlet.library.model.AddressBook)arguments[0]);
		}
