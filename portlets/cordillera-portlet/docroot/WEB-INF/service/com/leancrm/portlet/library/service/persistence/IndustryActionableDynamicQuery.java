 ...
 * @generated
 */
public abstract class IndustryActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public IndustryActionableDynamicQuery() throws SystemException {
		setBaseLocalService(IndustryLocalServiceUtil.getService());
		setClass(Industry.class);

		setClassLoader(com.leancrm.portlet.library.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("industryId");
	}
}