 ...
 * {@link com.leancrm.portlet.library.service.impl.IndustryLocalServiceImpl} and is the
 ...
 * @see com.leancrm.portlet.library.service.impl.IndustryLocalServiceImpl
 * @generated
 */
public class IndustryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.leancrm.portlet.library.service.impl.IndustryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.leancrm.portlet.library.model.Industry addIndustry(
	...
	*/
	public static com.leancrm.portlet.library.model.Industry createIndustry(
		long industryId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.leancrm.portlet.library.model.Industry deleteIndustry(
		long industryId)
	...
	*/
	...
	public static com.leancrm.portlet.library.model.Industry fetchIndustry(
		long industryId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.leancrm.portlet.library.model.Industry getIndustry(
		long industryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.leancrm.portlet.library.model.Industry> getIndustries(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.leancrm.portlet.library.model.Industry updateIndustry(
		com.leancrm.portlet.library.model.Industry industry)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.leancrm.portlet.library.model.Industry addIndustry(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addIndustry(name);
	}

	public static java.util.List<com.leancrm.portlet.library.model.Industry> getAll() {
		return getService().getAll();
	}

	public static java.util.List<com.leancrm.portlet.library.model.Industry> getAllOrdered() {
		return getService().getAllOrdered();
	}

	public static java.util.List<com.leancrm.portlet.library.model.Industry> getIndustryByName(
		java.lang.String name) {
		return getService().getIndustryByName(name);
	}
	...
	public static IndustryLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					IndustryLocalService.class.getName());

			if (invokableLocalService instanceof IndustryLocalService) {
				_service = (IndustryLocalService)invokableLocalService;
			}
			else {
				_service = new IndustryLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(IndustryLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(IndustryLocalService service) {
	}

	private static IndustryLocalService _service;
}