 ...
 * @generated
 */
public abstract class ContractActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ContractActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ContractLocalServiceUtil.getService());
		setClass(Contract.class);

		setClassLoader(com.leancrm.portlet.library.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("contractId");
	}
}