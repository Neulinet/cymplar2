...
/**
 * The persistence utility for the address book service. This utility wraps {@link AddressBookPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AddressBookUtil {
	 ...
	 */
	public static void clearCache(AddressBook addressBook) {
		getPersistence().clearCache(addressBook);
	}
	 ...
	 */
	public static List<AddressBook> findWithDynamicQuery(
	 ...
	 */
	public static AddressBook update(AddressBook addressBook)
		throws SystemException {
		return getPersistence().update(addressBook);
	}
	...
	public static AddressBook update(AddressBook addressBook,
		...
		return getPersistence().update(addressBook, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(addressBook);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(addressBooks);
	}
	...
	*/
	public static com.leancrm.portlet.library.model.AddressBook create(
		long addressBookId) {
	...
	*/
	public static com.leancrm.portlet.library.model.AddressBook remove(
		long addressBookId)
	...
	public static com.leancrm.portlet.library.model.AddressBook updateImpl(
		com.leancrm.portlet.library.model.AddressBook addressBook)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(addressBook);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.leancrm.portlet.library.model.AddressBook findByPrimaryKey(
		long addressBookId)
		throws com.leancrm.portlet.library.NoSuchAddressBookException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.leancrm.portlet.library.model.AddressBook fetchByPrimaryKey(
		long addressBookId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.leancrm.portlet.library.model.AddressBook> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AddressBookPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AddressBookPersistence)PortletBeanLocatorUtil.locate(com.leancrm.portlet.library.service.ClpSerializer.getServletContextName(),
					AddressBookPersistence.class.getName());

			ReferenceRegistry.registerReference(AddressBookUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(AddressBookPersistence persistence) {
	}

	private static AddressBookPersistence _persistence;
}